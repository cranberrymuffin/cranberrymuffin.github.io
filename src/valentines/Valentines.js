    ...
    return (
        <div id="settings">
            ...
            <div id="sliders">
                ...
                <input id="green" value={green} onChange={setGreen} key="green" type="range" min="0" max="255" />
                <input id="blue" value={blue} onChange={setBlue} key="blue" type="range" min="0" max="255" />
            </div>
        </div>
    )
}
