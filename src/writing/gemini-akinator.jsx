      ...
      <div id="blog" className="blog">
        <div id="writing" className="writing">
          ...
          <p>
            ...
            bundled into static files using <strong>npm build</strong>,
          ...
          <p>
            ...
            back to the frontend. The static React files are served by the
            backend via <code>node server.js</code>.
          </p>
          <p>
          ...
          <p>
            To host both the frontend and backend, I use <strong>Disco</strong>,
            a reliable platform for deploying full-stack applications.{' '}
          ...
          <p>
            Additionally, the <strong>server</strong> I’m using to run this app
            is a <strong>Raspberry Pi</strong> located at the{' '}
          ...
          <p>
            At the heart of the app is the <strong>Gemini API</strong> by
            Google, which powers the AI's ability to ask smart yes/no questions
            and process the user's answers. The <strong>Gemini API</strong>{' '}
            leverages advanced text generation to create dynamic and relevant
            questions that make the game feel interactive and engaging.
          </p>
          <p>
            ...
            documentation enables me to establish a conversation flow where the
            AI interacts with the user based on previous responses. This allows
            the AI to adjust its questions dynamically and refine the process of
