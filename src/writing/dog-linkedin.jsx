    ...
    <div id="main" className="main">
      ...
      <div id="blog" className="blog">
        <div id="writing" className="writing">
          ...
          <p>
            You still need some version of it to participate in professional
            life. Most recently I needed one to attend a{' '}
            <a
          ...
          <p>
            ...
            <code>LinkedInProfileTemplate</code> — each profile is now just a
            data file of experience entries, posts, and skills, passed as props
          ...
          <p>
            The template is made up of smaller pieces, each with a distinct
            reason to exist:
          </p>
          <ul>
            <li>
              <code>Navbar</code> renders the LinkedIn-style top bar — logo,
              search, and nav icons. It's also responsive: at narrower widths
              the search input collapses to just an icon, and the nav item
            ...
            <li>
              ...
              and projects because all three have the same shape: a logo, a
              title, a subtitle, and optional dates. One component handles all
              of them.
            </li>
            <li>
            ...
            <li>
              ...
              <code>ActivitySection</code> — profile image, author, timestamp,
              and content. <code>ActivitySection</code> maps over an array of
...
└── ActivitySection
    └── Carousel
        └── Post`}</pre>
          <p>
            Loretta, for her part, has no complicated feelings about any of
            this.
          </p>
        </div>
      </div>
