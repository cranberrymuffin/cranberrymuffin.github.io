    ...
    <div id="main" className="main">
      ...
      <div id="writing" className="writing">
        ...
        <p>
          ...
          and allows you to document your journey with photos. Here's the story
          of how I built it and what I learned along the way.
        </p>
        ...
        <p>
          ...
          breath, and trying to stay focused, it becomes mentally cumbersome and
          breaks your flow.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Swift & SwiftUI</strong> - Main development language and UI
            framework
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            accuracy (ignoring readings worse than 20 meters), minimum distance
            moved (2 meters), and time intervals (2 seconds between updates) for
            better data quality.
          </li>
          <li>
            <strong>Moving Average Smoothing:</strong> Uses a buffer of the last
            3 location readings to smooth out GPS noise and prevent erratic
            jumps.
          </li>
          <li>
        ...
        <p>
          Using ActivityKit, Path Recorder displays a lock screen widget showing
          current GPS coordinates, distance traveled, elapsed time, and
          pause/resume status. The implementation handles app termination and
          restoration, automatically resuming Live Activities when the app is
          relaunched.
        </p>
        <h3>Persistent State Management</h3>
        <p>
          Recordings survive app termination thanks to a robust persistence
          system using UserDefaults. All GPS locations, timestamps, segment IDs,
          distance, elapsed time, and photos are saved. The app detects
        ...
        <ul>
          ...
          <li>
            Saved to local storage with unique filenames and associated with the
            current path.
          </li>
          <li>
          ...
          <li>
            Photos captured outside the app while recording can be uploaded from
            the photo library after activity completion.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            location, but you can disable this by touching the map; a re-center
            button appears as needed.
          </li>
          <li>
          ...
          <li>
            <strong>Path Editing:</strong> Resume any completed path to continue
            recording, perfect for multi-day hikes or long pauses.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Hand-Crafted Visual Elements:</strong> Custom Core Graphics
            for glowing blue dots, solid waypoints, photo bubbles, and rounded
            polylines.
          </li>
          <li>
        ...
        <p>
          ...
          recordings safe, with Live Activity management across app lifecycles.
        </p>
        ...
        <p>
          Managing recording, pausing, editing, and photo states across multiple
          views is handled by a centralized LocationManager using
