...
function generateRandomParticleInSphere(radius) {
    ...
    return [x, y, z];
              ...
              <li>
                ...
                creating an illusion of a snowstorm. We can modify the rotation
...
useFrame((state, delta) => {
    snow.current.rotation.x -= delta * 0.05
              ...
              <li>
                The camera is positioned at the very center of this sphere,
                giving the viewer the perspective of standing in the middle of
                the storm.
              </li>
            </ol>
          </p>
